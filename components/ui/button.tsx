...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        locked:"bg-neutral-200 text-primary-foreground hover:bg-neutral-400/90 border-neutral-400 border-b-4 active:border-b-0", 
        default:
        ...
        secondary:
          "bg-owl text-primary-foreground hover:bg-owl/90 border-green-600 font-bold border-b-4 active:border-b-0 ",
        ...
        sidebarOutline:
          ...
          defaultOutline:"bg-white text-black border-slate-200 border-2 border-b-4 active:border-b-2 hover:bg-slate-100 text-sky-500",
      },
      size: {
